...
@Autonomous(name="Blue- delayed", group = "!", preselectTeleOp = "MTeleOp")
@Config
public class blue_delayed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        timer.reset();
        while (timer.milliseconds() < 15000 && opModeIsActive()) {idle();}
