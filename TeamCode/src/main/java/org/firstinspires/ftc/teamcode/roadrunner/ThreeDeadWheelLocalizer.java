...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2083.008517777582; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2198.0146895897037; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2310.73784130599; // x position of the perpendicular encoder (in tick units)
    }
