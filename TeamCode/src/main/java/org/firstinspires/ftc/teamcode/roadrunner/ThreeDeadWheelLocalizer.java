...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2183.3152489945915; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2111.4543958763766; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 225.88409328856227; // x position of the perpendicular encoder (in tick units)
    }
